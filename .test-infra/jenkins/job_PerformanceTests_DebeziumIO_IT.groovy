...
job(jobName) {
  ...
  common.enablePhraseTriggeringFromPullRequest(
      delegate,
      'Java DebeziumIO Performance Test',
      'Run Java DebeziumIO Performance Test')
  ...
  k8s.apply(common.makePathAbsolute("src/.test-infra/kubernetes/postgres-debezium-cdc/postgres-debezium-cdc-service-for-local-dev.yml"))
  ...
  steps {
    gradle {
      ...
      tasks(":sdks:java:io:jdbc:integrationTest --tests org.apache.beam.io.cdc.DebeziumIOIT")
    }
  }
}
