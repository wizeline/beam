...
public class DebeziumHistory extends AbstractDatabaseHistory {
    ...
    private Map<String, RestrictionTracker<DebeziumOffsetHolder, Map<String, Object>>>
            restrictionTrackers;

    public DebeziumHistory(Map<String, RestrictionTracker<DebeziumOffsetHolder,  Map<String, Object>>>
                                   restrictionTrackers) {
    ...
    public void start() {
        ...
        RestrictionTracker<DebeziumOffsetHolder, Map<String, Object>> tracker = restrictionTrackers.get(
